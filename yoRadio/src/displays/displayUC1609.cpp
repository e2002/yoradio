...
#if DSP_MODEL==DSP_UC1609

#include "displayUC1609.h"
...
#if DSP_HSPI
DspCore::DspCore(): UC1609(LCDWIDTH, LCDHEIGHT, &SPI2, TFT_DC, TFT_RST, TFT_CS, DEF_SPI_FREQ) {}
#else
DspCore::DspCore(): UC1609(LCDWIDTH, LCDHEIGHT, &SPI, TFT_DC, TFT_RST, TFT_CS, DEF_SPI_FREQ) {}
#endif
...
void DspCore::writeFillRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color) {
  ...
  UC1609::writeFillRect(x, y, w, h, color);
}
